...
nohup python train.py --id DPTN_higher_spade_dec --tf_log --gpu_ids 0 --type_En_c default --type_Dc spade --pose_nc 18 --batchSize 24 --continue_train > DPTN_higher_spade_dec.out &
