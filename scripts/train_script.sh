...
nohup python train.py --id SPAIN_cf --tf_log --gpu_ids 2 --type_En_c noise --type_Dc spade --pose_nc 41 --batchSize 12 --num_workers 10 --cf_guidance > SPAIN_cf.out &
nohup python train.py --id SPAIN --tf_log --gpu_ids 1 --type_En_c noise --type_Dc spade --pose_nc 41 --batchSize 12 --num_workers 10  > SPAIN.out &
